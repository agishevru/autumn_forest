""" Модуль содержит класс Snow создает снежинки в рандомных точках, и запускает анимацию падения."""
import simple_draw as sd


class Snow:
    """ Создает снегопад из q снежинок. При инициации экзэмпляра задается q: int """
